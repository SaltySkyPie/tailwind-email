...
class TailwindClassParser:
    ...
    STATE_PREFIXES = frozenset([
        ...
        "focus-within:", "focus-visible:", "motion-safe:",
        "motion-reduce:", "dark:", "print:", "portrait:", "landscape:",
    ])

    # Classes that are not supported in email and should be skipped
    UNSUPPORTED_CLASSES = frozenset([
        # Flexbox (poor email support)
        "flex", "inline-flex", "flex-row", "flex-row-reverse",
        "flex-col", "flex-col-reverse", "flex-wrap", "flex-wrap-reverse",
        ...
        "gap-8", "gap-9", "gap-10", "gap-11", "gap-12",
        ...
        "transition-shadow", "transition-transform", "duration-75", "duration-100",
        "duration-150", "duration-200", "duration-300", "duration-500", "duration-700",
        "duration-1000", "ease-linear", "ease-in", "ease-out", "ease-in-out",
        ...
        "contrast-0", "contrast-50", "contrast-75", "contrast-100", "contrast-125",
        "contrast-150", "contrast-200", "grayscale", "grayscale-0",
        "hue-rotate-0", "hue-rotate-15", "hue-rotate-30", "hue-rotate-60",
        "hue-rotate-90", "hue-rotate-180", "invert", "invert-0",
        "saturate-0", "saturate-50", "saturate-100", "saturate-150", "saturate-200",
        "sepia", "sepia-0", "drop-shadow", "drop-shadow-sm", "drop-shadow-md",
        ...
        "scroll-auto", "scroll-smooth", "scroll-m-0", "scroll-m-1",
        "scroll-p-0", "scroll-p-1", "snap-start", "snap-end", "snap-center",
        "snap-align-none", "snap-normal", "snap-always", "snap-mandatory",
        "snap-proximity", "snap-none", "snap-x", "snap-y", "snap-both",
        ...
        "columns-11", "columns-12", "columns-auto", "columns-3xs", "columns-2xs",
        "columns-xs", "columns-sm", "columns-md", "columns-lg", "columns-xl",
        "columns-2xl", "columns-3xl", "columns-4xl", "columns-5xl", "columns-6xl",
        "columns-7xl",
        ...
        "mix-blend-luminosity", "mix-blend-plus-darker", "mix-blend-plus-lighter",
        ...
        "order-11", "order-12", "order-first", "order-last", "order-none",
    ...
    def _is_unsupported_pattern(self, cls: str) -> bool:
        ...
        if cls.startswith("-m"):
            ...
            if rest.startswith("-") or rest.startswith(("x-", "y-", "t-", "r-", "b-", "l-", "s-", "e-")):
                return True
    ...
    def is_tailwind_class(self, cls: str) -> bool:
        ...
        single_words = {
            ...
            "table-row-group", "table-row", "list-item",
            "border", "border-collapse", "border-separate",
            "rounded", "container",
        }
        ...
        safe_prefixes = (
            ...
            "overflow-", "object-", "list-", "decoration-",
            "outline-", "cursor-", "resize-", "appearance-",
            "inset-", "size-", "basis-", "aspect-", "align-",
            "whitespace-", "float-", "clear-",
        )
